...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenido, señor Aldo';
    ...
    handle(handlerInput) {
        ...
        if (!tipoPregunta) {
            ...
            switch (tipoPregunta.toLowerCase()) {
                case 'comida':
                    speakOutput = 'la comida favorita es la carne de puerco en salsa verde, con arroz';
                    break;
                case 'creador':
                    speakOutput = 'Mi creador es Aldo Tolentino, el mero mero';
                    break;
                case 'deporte':
                    speakOutput = 'su deporte favorito es el futbol';
                    break;
                case 'edad':
                    speakOutput = 'Aldo tiene al dia de hoy 24 años';
                    break;
                case 'musica':
                    speakOutput = 'su musica favorita es la musica house';
                    break;
                default:
                    speakOutput = 'No entendí bien tu pregunta. ¿Podrías repetirla de otra manera?';
                    break;
        ...
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt('¿Deseas hacer otra pregunta?')
            .getResponse();
    }
};
